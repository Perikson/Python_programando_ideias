""""""
"""
1 - Crie 3 listas: uma com o nome de 3 companhias aéreas, e as outras duas representando o número 
de passageiros por companhia em dois voos: voo1 e voo2. Utilize zip(), lambda e map() para obter 
o valor máximo de passageiros por companhia nos dois voos e associar estes valores com o nome das 
companhias, formando uma lista de tuplas. Por fim, utilizar filter() e lambda para determinar a 
classificação da companhia, conforme indicado nos dados abaixo.
