""""""
"""
1 - Receba numeros inteiros do usuário e armazene-os em uma lista. Crie uma condição para o número 0
finalizar o processo de preenchimento. Após isso, imprima o maior valor da lista utilizando as 
funções sorted() e len(). Por fim, utilize reversed() para inverter a lista e obtenha, pelo índice, 
o valor intermediário da mesma. 
