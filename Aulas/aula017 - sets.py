...
Quando utilizar?
 - São utilizados quando você não precisa se preocupar com ordenação e repetição de elementos.
...
Forma 2: Discard()
conjunto = {1,3,5,7,9,11}
retorno = conjunto.discard(5) #variavel.discard(elemento a ser removido)
print(conjunto)
print(retorno) #Retorna None
...
a)Deep Copy: copy()
#Cada conjunto vai trabalar separadamente
Ex:
